					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : Nyarutarama at Adedeji's place</p>
								<p>Email : <a href="mailto:mashauri@programmer.net">d.mbugua@alustudent</a></p>
								<p>Phone : <a href="tel:+255689938643">+254 795817382</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Errand software</p>
