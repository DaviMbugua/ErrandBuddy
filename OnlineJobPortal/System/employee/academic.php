...
<head>
	...
	<title>Errand Jobs - Academic Qualifications</title>
		...
		<div class="main-wrapper">
			...
			<footer class="footer-wrapper">
				...
				<div class="bottom-footer">
					...
					<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Errand Vision Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by David and Irene</a></li>
								</ul>
