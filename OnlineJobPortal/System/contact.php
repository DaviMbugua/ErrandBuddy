...
<head>
	...
	<title>Errand Buddy - Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Nyarutarama, <br/> PO.BOX at Karl Gomez, <br/>Dejis place</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:nightingale.nath2@gmail.com">d.mbugua@alustudent.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+233 546 607 474">+254795817382</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Errand Buddy</h5>
											<p>Developed by David Mbugua and Irene Mutamuliza.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Errand Jobs Contact</h5>
								
								<p>Address : Nyarutarama at Deji's house</p>
								<p>Email : <a href="mailto:nightingale.nath2@gmail.com">d.mbugua@alustudent.com</a></p>
								<p>Phone : <a href="tel:+233546607474">+254795817382</a></p>
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by David Mbugua and Irene M</a></li>
								</ul>
